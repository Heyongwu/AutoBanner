package com.example.administrator.autobanner.view;
...
import com.example.administrator.autobanner.GlobalVar;
import com.example.administrator.autobanner.R;

import java.util.List;



public class BannerWithPoint extends FrameLayout implements AutoBanner.BannerSelectListener,AutoBanner.BannerClickListener{
    private AutoBanner bannerGroup;
    ...
    private void initBannerViewGroup() {
        bannerGroup = new AutoBanner(getContext());
